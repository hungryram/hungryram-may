...
const solutions = [
  ...
  },
  {
    ...
    description: 'Speak directly to your customers with a professional website',
    href: '/services/small-business-website-design/',
    icon: ChartBarIcon,
  },
  {
    name: 'Real Estate IDX Websites',
    description: "Get a high-performance real estate website connected to your MLS board",
    href: '/services/agent-idx-websites/',
    icon: OfficeBuildingIcon
  },
  {
    name: 'View Our Work',
    description: 'View websites we built for various businesses.',
    href: '/portfolio/',
    icon: StarIcon,
  },
]
const callsToAction = [
  { name: 'Contact Sales', href: 'https://calendly.com/hungry-ram', icon: PhoneIcon },
]
const resources = [
  {
    name: 'FAQ',
    description: 'Check out our FAQ for answers to your questions',
    href: '/faq/',
    icon: SupportIcon,
  },
  {
...
const recentPosts = [
  { id: 1, name: 'The Manifest Awards Hungry Ram as Most Reviewed Agency in Anaheim', href: '/blog/most-reviewed-design-agency/' },
  { id: 2, name: 'The 2 Important Factors in Real Estate SEO', href: '/blog/the-2-important-factors-in-real-estate-seo/' },
  { id: 3, name: 'Why I Use Jamstack', href: '/blog/why-i-use-jamstack/' },
]
      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="/">
              <span className="sr-only">Hungry Ram Web Design</span>
              <StaticImage
                    ...
                    <Popover.Panel className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div className="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                          <div>
                            <h3 className="text-sm tracking-wide font-medium text-gray-500 uppercase">Featured Blog Posts</h3>
